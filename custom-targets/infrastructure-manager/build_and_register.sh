...
CT_SRCDIR="infrastructure-manager/im-deployer"
CT_IMAGE_NAME=infra-manager
CT_TYPE_NAME=infrastructure-manager
CT_CUSTOM_ACTION_NAME=infra-manager-deployer
CT_GCS_DIRECTORY=infra-manager
CT_SKAFFOLD_CONFIG_NAME=infraManagerConfig
