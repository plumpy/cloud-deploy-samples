...
CT_SRCDIR="vertext-ai/model-deployer"
CT_IMAGE_NAME=vertexai
CT_TYPE_NAME=vertex-ai-endpoint
CT_CUSTOM_ACTION_NAME=vertex-ai-model-deployer
CT_GCS_DIRECTORY=vertexai
CT_SKAFFOLD_CONFIG_NAME=vertexAiConfig
