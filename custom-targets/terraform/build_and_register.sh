...
CT_SRCDIR="terraform/terraform-deployer"
CT_IMAGE_NAME=terraform
CT_TYPE_NAME=terraform
CT_CUSTOM_ACTION_NAME=terraform-deployer
CT_GCS_DIRECTORY=terraform
CT_SKAFFOLD_CONFIG_NAME=terraformConfig
